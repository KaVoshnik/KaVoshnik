...
Currently working on my main projects:

- 🐍 [MultiplayerUltimateSnakeAttack](https://github.com/KaVoshnik/MultiplayerUltimateSnakeAttack) — a real-time multiplayer game built with Node.js, WebSockets and PostgreSQL
- 💻 [MyOS](https://kavoshnik.github.io/) — my own operating system built from scratch using C and x86 Assembly

I like working on projects where I can understand the whole stack — from low-level systems to backend architecture and networking.
...
- ✅ Front-end part of a [project management platform](https://github.com/Avairon/projectsWMS) developed for college

### Fun facts:

- 🖥️ I run a self-configured home server on Android TV
